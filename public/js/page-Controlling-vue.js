...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  setup: function setup(__props, _ref) {
    ...
    var activeSensors = (0,vue__WEBPACK_IMPORTED_MODULE_0__.computed)(function () {
      ...
      if (!activeGreenhouse || !Array.isArray(activeGreenhouse === null || activeGreenhouse === void 0 ? void 0 : activeGreenhouse.sensor)) {
        return [];
      }
      var uniqueSensors = [];
      var seenNames = new Set();
      var _iterator = _createForOfIteratorHelper(activeGreenhouse.sensor),
        _step;
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          var sensor = _step.value;
          var normalizedName = String(sensor.name).trim().toLowerCase();
